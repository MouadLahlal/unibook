...
const ControlButton = ({ onClick, disabled, children, className }: { onClick: MouseEventHandler<HTMLButtonElement>, disabled: boolean, children: React.ReactNode, className: string }) => (
